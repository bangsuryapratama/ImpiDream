    ...
    <aside class="hidden lg:flex w-64 bg-slate-900 text-white flex-col fixed inset-y-0 z-40">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all {{ request()->routeIs('admin.users.*') ? 'bg-[#2E7D64] text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">
            ...
            <a href="{{ route('admin.dreams.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all {{ request()->routeIs('admin.dreams.*') ? 'bg-[#2E7D64] text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">
